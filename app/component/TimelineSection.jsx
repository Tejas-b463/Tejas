...
export default function TimelineSection() {
      ...
      const data = [
    {
      ...
      content: (
        <div>
          ...
          {"  Built and deployed Projects using MERN Stack and Tailwind CSS from scratch"}
          </p>
           <div className="mb-8">
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
  {"I completed my Master's in Computer Applications and developed a Blood Donation Management System to streamline donor and recipient connections."}
          </p>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-4">
            {"Deployed 4 project on vercel and render"}
          </p>
          <div className="mb-8">
            <div className="flex gap-2 items-center text-neutral-700 dark:text-neutral-300 text-xs md:text-sm">
